...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='shipdata/yolov5n6.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='shipdata/yolov5n.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='shipdata/shipdata.yaml', help='dataset.yaml path')
...
def main(opt, callbacks=Callbacks()):
    ...
    if opt.resume and not check_wandb_resume(opt) and not opt.evolve:  # resume an interrupted run
        ...
        with open(Path(ckpt).parent.parent / 'opt.yaml', errors='ignore', encoding='utf-8') as f:
